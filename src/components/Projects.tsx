...
const projects: Project[] = [
  {
    ...
    url: 'https://edyc.co.uk/',
    size: 'large',
  },
  {
    title: 'AdaptLearningNI',
    description: 'Inquiry-based learning platform for a pioneering educational business in Holywood, Northern Ireland. Modern interface for educational content delivery and student engagement.',
    tech: ['React', 'Node.js', 'PostgreSQL', 'AWS', 'Railway'],
    url: 'https://adaptlearningni.com/',
    size: 'large',
  },
  {
